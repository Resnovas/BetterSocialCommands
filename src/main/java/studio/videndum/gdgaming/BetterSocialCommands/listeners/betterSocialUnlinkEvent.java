...
public class betterSocialUnlinkEvent implements ListenerTemplate {
    ...
    public void onSocialUnLink (SocialUnlinkEvent event) {
        ...
        if (IdentifierConfig.getBoolean("enabled", false)) {
            ...
            List<String> Commands = IdentifierConfig.getStringList("unlinkedCommands");
